...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{raumzeigermaschine1.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{raumzeigermaschine2.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.55\textwidth]{dqkoordinaten.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{blockbildclarkeparkkomplett.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{blockbildinverseclarkeparkkomplett.pdf}
