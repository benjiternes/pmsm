...
Gleichung~(\ref{eqn:eqn:mi-gleichung}) beschreibt das Drehmoment der elektrischen Maschine als Ergebnis des Kreuzproduktes zwischen Ständerflussverkettung und Ständerstrom.
...
%	\centering
	...
	\label{fig:foc-dc-ac}
	\caption{Beispiel einer Feldorientierten Regelung anhand eines Blockschaltbildes.}
\end{figure}
\end{landscape}
%%% Local Variables: 
%%% mode: latex
