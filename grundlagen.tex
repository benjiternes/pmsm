...
\caption{Phasenspannung eines symmetrischen Drehstromerzeugers in Abhängigkeit der Zeit.}
\end{figure}
...
Die folgende Abbildung~\ref{fig:strombelag-neu} zeigt die Modellvorstellung der obigen Beschreibung:
...
festgelegt wird. \autocite[S.~199]{hofmann2013}
Betrachtet man jetzt die Polteilung $\tau_\i{p}$ mit 
...
\begin{align}
A = \frac{m w I}{p \cdot \tau_\i{p}}.
\end{align}

\begin{quote}
\enquote{Aus dem Strombelag $A$ wird bei rotatorischen Maschinen abhängig von der Umfangskoordinate mit $A(x)$, wenn:
\begin{itemize}
...
Diese ist wichtig für die Berechnung von Streuungs- und Verlusteffekten in der Maschine.
