...
\begin{align}
\tau_\i{p} = \frac{\pi \cdot d_\i{i}}{2p} \label{eqn:strombelag3}
\end{align}

so wird aus Gl.~\ref{eqn:strombelag2} und Gl.~\ref{eqn:strombelag3} bei voller Bewicklung über eine Polteilung
